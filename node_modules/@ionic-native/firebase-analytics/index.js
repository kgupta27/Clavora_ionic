...
var FirebaseAnalytics = (function (_super) {
    ...
    /**
       ...
       * @return {Promise<any>} Returns a promise
       */
    FirebaseAnalytics.prototype.logEvent = /**
       * Logs an app event.
       * Be aware of automatically collected events.
       * @param {string} name The name of the event
       * @param {any} params Some param to configure something
    ...
    /**
       ...
       * @return {Promise<any>} Returns a promise
       */
    FirebaseAnalytics.prototype.setUserId = /**
       * Sets the user ID property.
       * This feature must be used in accordance with Google's Privacy Policy.
       * @param {string} id The user ID
       * @return {Promise<any>} Returns a promise
    ...
    /**
       ...
       * @return {Promise<any>} Returns a promise
       */
    FirebaseAnalytics.prototype.setUserProperty = /**
       * This feature must be used in accordance with Google's Privacy Policy.
       * Be aware of automatically collected user properties.
       * @param {string} name The property name
       * @param {string} value The property value
    ...
    /**
       ...
       * @return {Promise<any>} Returns a promise
       */
    FirebaseAnalytics.prototype.setEnabled = /**
       * Sets whether analytics collection is enabled for this app on this device.
       * @param {boolean} enabled
       * @return {Promise<any>} Returns a promise
       */
    ...
    /**
       ...
       * @return {Promise<any>} Returns a promise
       */
    FirebaseAnalytics.prototype.setCurrentScreen = /**
       * Sets the current screen name, which specifies the current visual context in your app.
       * This helps identify the areas in your app where users spend their time and how they interact with your app.
       * @param {string} name The name of the screen
       * @return {Promise<any>} Returns a promise
