...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__calendar__ = __webpack_require__(860);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_ion2_calendar__ = __webpack_require__(854);
    ...
    CalendarPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["NgModule"])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["IonicPageModule"].forChild(__WEBPACK_IMPORTED_MODULE_4__calendar__["a" /* CalendarPage */]),
...
var config_1 = __webpack_require__(848);
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__(1);
var ionic_angular_1 = __webpack_require__(22);
var calendar_service_1 = __webpack_require__(849);
var moment = __webpack_require__(2);
var config_1 = __webpack_require__(848);
...
var calendar_model_1 = __webpack_require__(850);
var config_1 = __webpack_require__(848);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__providers_questionnaire_questionnaire__ = __webpack_require__(69);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__providers_constants_constants__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ionic_angular__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ion2_calendar__ = __webpack_require__(854);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_firebase_analytics__ = __webpack_require__(68);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CalendarPage = /** @class */ (function () {
    function CalendarPage(viewCtrl, questionnaire, constants, firebaseAnalytics, platform, navParams) {
        this.viewCtrl = viewCtrl;
    ...
    CalendarPage.prototype.ionViewWillEnter = function () {
        ...
        if (this.platform.is('cordova'))
            this.firebaseAnalytics.logEvent('page_view', { page: "Calendar" })
        ...
        this.date = __WEBPACK_IMPORTED_MODULE_5_moment__().format('YYYY-MM-DD');
    };
    CalendarPage.prototype.dateSelect = function () {
        console.log(this.date);
    };
    CalendarPage.prototype.getDosageStats = function (firstDate) {
        var _this = this;
        ...
        this.questionnaire.getCalendarActivity(firstDate, lastDate, this.selectedProfile).subscribe(function (resp) {
            console.log(resp);
            _this.optionsMulti.daysConfig = [];
            for (var _i = 0, _a = resp.result; _i < _a.length; _i++) {
                var dose = _a[_i];
                _this.date = dose.dosageTakenDate;
                var doseRemaining = dose.totalDose - dose.doseTaken;
                _this.optionsMulti.daysConfig.push({
                    date: new Date(dose.dosageTakenDate),
                    cssClass: (doseRemaining < dose.totalDose && dose.doseTaken != 0 ? dose.totalDose == dose.doseTaken ? '' : 'partial' : dose.totalDose > 0 && doseRemaining == dose.totalDose ? 'incomplete' : '') + (_this.date != __WEBPACK_IMPORTED_MODULE_5_moment__().format('YYYY-MM-DD') ? '' : ' on-selected')
                });
                console.log(_this.optionsMulti.daysConfig);
                // this.date = dose.dosageTakenDate;
            }
            // let date = new Date();
            // this.date = date.getFullYear() + "-" + (date.getMonth() + 1) + "-" + date.getDate();
            _this.date = __WEBPACK_IMPORTED_MODULE_5_moment__().format('YYYY-MM-DD');
            _this.cal.options = _this.optionsMulti;
            _this.loaded = true;
        }, function (err) {
            console.log(err);
            _this.loaded = true;
    ...
    CalendarPage.prototype.monthChange = function (data) {
        console.log(data);
        this.loaded = false;
        var firstDate = data.newMonth.dateObj;
        // let lastDate = new Date(firstDate.getFullYear(), firstDate.getMonth() + 1, 0);
        this.getDosageStats(firstDate);
    };
    CalendarPage.prototype.done = function () {
        console.log(this.date);
        this.viewCtrl.dismiss(this.date);
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["ViewChild"])('calendar'),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_4_ion2_calendar__["CalendarComponent"])
    ], CalendarPage.prototype, "cal", void 0);
    CalendarPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Component"])({
            selector: 'page-calendar',template:/*ion-inline-start:"/Users/kanikagupta/Documents/clavora-hybrid/src/pages/calendar/calendar.html"*/'<!--\n  Generated template for the CalendarPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>{{constants.LANGS.PAGE_TITLE_DURATION}}</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n  <div class="my-cal-date">{{date | amDateFormat: \'ddd, MMM D\' }}</div>\n  <ion-calendar #calendar [hidden]="!loaded" [(ngModel)]="date" [options]="optionsMulti" [type]="type" [format]="\'YYYY-MM-DD\'"\n    (onSelect)="dateSelect()" (monthChange)="monthChange($event)">\n  </ion-calendar>\n  <default-button block [text]="constants.LANGS.PAGE_LABEL_GO_TO_DATE" (click)="done()"></default-button>\n  <div class="separator"></div>\n\n  <ion-row>\n    <ion-col col-6>\n      <div class="legend days-btn partial"></div>\n      <div class="legend-text">{{constants.LANGS.PAGE_LABEL_PARTIAL}}</div>\n    </ion-col>\n    <ion-col col-6>\n      <div class="legend days-btn incomplete"></div>\n      <div class="legend-text">{{constants.LANGS.PAGE_LABEL_INCOMPLETE}}</div>\n    </ion-col>\n    <ion-col col-12>\n      <div class="legend days-btn"></div>\n      <div class="legend-text">{{constants.LANGS.PAGE_LABEL_NONE_SUPP}}</div>\n    </ion-col>\n    <!-- <ion-col col-6>\n      <div class="legend days-btn on-selected"></div>\n\n    </ion-col> -->\n  </ion-row>\n</ion-content>\n'/*ion-inline-end:"/Users/kanikagupta/Documents/clavora-hybrid/src/pages/calendar/calendar.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3_ionic_angular__["ViewController"],
            __WEBPACK_IMPORTED_MODULE_0__providers_questionnaire_questionnaire__["a" /* QuestionnaireProvider */],
            __WEBPACK_IMPORTED_MODULE_1__providers_constants_constants__["a" /* ConstantsProvider */],
            __WEBPACK_IMPORTED_MODULE_6__ionic_native_firebase_analytics__["a" /* FirebaseAnalytics */], __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["Platform"],
...
var ionic_angular_1 = __webpack_require__(22);
var calendar_service_1 = __webpack_require__(849);
var index_1 = __webpack_require__(862);
function calendarController(modalCtrl, calSvc) {
...
var month_component_1 = __webpack_require__(856);
var calendar_component_1 = __webpack_require__(857);
var month_picker_component_1 = __webpack_require__(863);
